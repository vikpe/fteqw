...
- [Demo event redesign](demo_event_redesign.md) — planned refactor: per-kind structs, collapse to TOOK / DEATH / MOD_EVENT, internal FRAG/DROPS rows merged at end of scan
- [Event subsystem handoff](event_subsystem_handoff.md) — current state of cl_hub_demo_event after the May 2026 strip-down; read before continuing the rewrite
